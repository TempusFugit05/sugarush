...
public partial class Character : CharacterBody3D
{
	...
	{
		Pickup PickupObj = (Pickup)Obj.GetParent(); // Get pickup object (since we are only detecting the pickup area of the pickup object)
		PickupObj.MarkAsPickedUp(); // Mark object as picked up to be handled on its iteration
